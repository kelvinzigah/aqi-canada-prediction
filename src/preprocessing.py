...
#function so that I can call it for both 2019 and 2020-2024 datasets
def preprocess_air_quality(df):

    df = df.copy()

    # Standardize inconsistent pollutant naming for 2019
...
processed_2020_2024 = preprocess_air_quality(df) # data set for 2020 to 2024
processed_2019 = preprocess_air_quality(df2019) #dataset for 2019

# Save processed dataset

processed_2020_2024.to_csv( #this is the main dataset that will be used for modeling
    "data/processed/air_quality_project_dataset.csv",
    index=False
)

processed_2019.to_csv( # this is the dataset for 2019 that will be used for demo
    "data/processed/air_quality_project_dataset_Demo.csv",
    index=False
)
...
plt.plot(processed_2020_2024["Date"], processed_2020_2024["AQHI"])
...
#NO2 over time plot
plt.figure(figsize=(12,5))
plt.plot(processed_2020_2024["Date"], processed_2020_2024["NO2"])
...
#PM25 over time plot
plt.figure(figsize=(12,5))
plt.plot(processed_2020_2024["Date"], processed_2020_2024["PM25"])
...
#O3 over time plot
plt.figure(figsize=(12,5))
plt.plot(processed_2020_2024["Date"], processed_2020_2024["O3"])
...
#AHI Histogram
plt.hist(processed_2020_2024["AQHI"], bins=30)
