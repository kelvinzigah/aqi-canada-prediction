...
Note:  Modifications to the continuous data published to the NAPS Data Query Tool are described at the end of this file.
...
---------------------------------------
Modifications to the continuous dataset
---------------------------------------
This section describes modifications to the continuous data published to the NAPS Data Query Tool.

March 2026
----------
- Published CO, NO2, NO, NOX, O3, PM2.5, PM10 and SO2 data for 1974-2024.

June 2026
---------
- Republished CO, NO2, NO, NOX, O3, PM2.5, PM10 and SO2 data for 2005-2024 to correct how some values were being rounded.
	- Previously, when rounding data from the NAPS database to their reported precision, half values were rounded to the nearest even number (e.g. an NO2 concentration of exactly 2.5 ppb was rounded to 2 ppb).
	- Now, when rounding data from the NAPS database to their reported precision, half values are rounded away from 0 (e.g. an NO2 concentration of exactly 2.5 ppb is rounded to 3 ppb).
	- This change was made to be consistent with the rounding convention prescribed in the NAPS QA/QC Guidelines.
	- Continuous data prior to 2005 were not republished since these data are not stored at a higher-than-reported precision in the NAPS database and are therefore not affected by this change.
- Added or removed some data from Manitoba following an investigation of the data.
	- Added O3 data from station 070119 for 2018.
	- Added SO2 data from station 070301 for 2013-2017.
	- Removed NO2/NO/NOX data from station 070118 for 2024.
	- Removed NO2/NO/NOX data from station 070119 for 2023-2024.
	- Removed NO2/NO/NOX data from station 070203 for 2024.
	- Removed NO2/NO/NOX data from station 070301 for 2023-2024.
	- Removed O3 data from station 070119 for 2024.
	- Removed O3 data from station 070203 for 2023-2024.
	- Removed O3 data from station 070301 for 2021-2024.
- In the Pollutant column of the "data.csv" file, changed the name of particulate matter ≤ 2.5 μm from "PM25" to "PM2.5".
- Removed a single erroneous SO2 concentration from station 050204 for 2024-01-01.
